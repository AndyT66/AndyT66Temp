...
//
// $Id: htmlarea.js 14380 2006-09-12 12:06:57Z m.gonzalez@lancaster.ac.uk $
...
function HTMLArea(textarea, config) {
	if (HTMLArea.checkSupportedBrowser()) {
		...
		this.doctype = '';
		/* CHANGE DONE BY CENTRE FOR E-SCIENCE. LANCASTER UNIVERSITY */
		this.setFunctionOnChange = htmlEditor_setFunctionOnChange;
		this.setFunctionOnSubmit = htmlEditor_setFunctionOnSubmit;
		/* END OF CHANGE*/
	}
};
...
HTMLArea.prototype.generate = function () {
	...
	if (textarea.form) {
		...
		f.onsubmit = function() {
			...
			/* CHANGE DONE BY CENTRE FOR E-SCIENCE. LANCASTER UNIVERSITY */
			if (editor.functionOnSubmit!=undefined)
				return editor.functionOnSubmit();
			/* END OF CHANGE */
		};
...
/* CHANGE DONE BY CENTRE FOR E-SCIENCE. LANCASTER UNIVERSITY */
function htmlEditor_setFunctionOnChange(f) {
	this.onChange = f;
}
function htmlEditor_setFunctionOnSubmit(f) {
	this.functionOnSubmit = f;
}
/* END OF CHANGE */
